...
if __name__ == '__main__':
    ...
    for app in apps:
        ...
        data_for_insert = database.get_matrix_event_data(app,  cdate, formatted_cdate, limit_version=True, version_count=5, limit_nation=True)
        ...
        data_for_insert = database.get_matrix_event_data(app,  cdate, formatted_cdate, limit_version=True, version_count=1, limit_nation=False)
